...
router.post('/send-otp', async (req, res) => {
  try {
    ...
    customer.otp = otp;
    customer.otpExpires = Date.now() + 10 * 60 * 1000; // 10 minutes
    await customer.save();
    console.log(`OTP for ${phone} is: ${otp}`); // For testing; replace with SMS service in production
...
// GET /api/auth/customer/me - Get logged-in customer's own details
